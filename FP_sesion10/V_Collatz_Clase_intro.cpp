...
/*
    ...
    en el rango, instancia un objeto de la clase Collatz, imprime su
...
public:
    ...
    // Modifica la base de la secuencia.
    // PRE: n >= 1
    // Parámetros:
    //   n: el nuevo valor para la base.
    void SetBase(int n) {
        if (n >= 1) {
            base = n;
        }
...
{   
    ...
    for (int i = minimo; i <= maximo; i++) {
        ...
        Collatz secuencia_actual;
        secuencia_actual.SetBase(i);
