...
// SESION 06
/*
    Validador de Contraseñas con Límite de Intentos.
    ...
    pedirla hasta que se llegue al máximo de 3 intentos.
    ...
    Salidas:
        - Mensaje de error si la contraseña no es válida en un intento.
        - Mensaje de éxito si la contraseña es aceptada en uno de los intentos.
...
int main() {
    ...
    const int MAX_INTENTOS = 3; // Límite de intentos
