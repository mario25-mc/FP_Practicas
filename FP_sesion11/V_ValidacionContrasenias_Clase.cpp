...
public:
    ...
    // Parámetros: p, la contraseña a validar.
    /***********************************************************************/
    ValidadorContrasenias(string p) 
        : passwd(p),
          mensaje("")
    {}
    ...
    bool EsValida() {
        ...
        bool lon_ok, mayus_ok, esp_ok, rep_ok;
        bool todo_ok;
        ...
        } else 
        {
            ...
            todo_ok = lon_ok && mayus_ok && esp_ok && rep_ok;
        }
...
int main(){
    ...
    do {
        ...
        ValidadorContrasenias validador(contrasenia);
